@echo off
rem ============================================================
rem  TangYuan Launcher v2.2.2 release build pipeline (bundled game)
...
rem  Output: dist\TangYuanLauncher-Setup-2.2.2.exe
rem ============================================================
setlocal
cd /d "%~dp0\.."
...
echo [5/5] done: dist\TangYuanLauncher-Setup-2.2.2.exe
endlocal
